...
const heroes = [
    ...
    { name: 'ixia', img: 'Assets/HeroPick/ixia.png', sound: 'Assets/Sound/ixia-select.ogg' },
    ...
    { name: 'natan', img: 'Assets/HeroPick/nathan.png', sound: 'Assets/Sound/natan.select.ogg' },
    { name: 'nolan', img: 'Assets/HeroPick/nolan.png', sound: 'Assets/Sound/nolan-select.ogg' },
    { name: 'novaria', img: 'Assets/HeroPick/novaria.png', sound: 'Assets/Sound/Novaria-move06.ogg' },
    { name: 'obsidia', img: 'Assets/HeroPick/obsidia.png', sound: 'Assets/Sound/Obsidia-select.ogg' },
    { name: 'odette', img: 'Assets/HeroPick/odette.png', sound: 'Assets/Sound/Odette.revamp.select.ogg' },
    { name: 'paquito', img: 'Assets/HeroPick/paquito.png', sound: 'Assets/Sound/Paquito.select.ogg' },
    { name: 'pharsa', img: 'Assets/HeroPick/parsha.png', sound: 'Assets/Sound/Pharsa.select.ogg' },
    { name: 'phoveus', img: 'Assets/HeroPick/phoveus.png', sound: 'Assets/Sound/Phoveus-select.ogg' },
    { name: 'popolandkupa', img: 'Assets/HeroPick/popolandkupa.png', sound: 'Assets/Sound/Popolandkupa.select.ogg' },
    { name: 'rafaela', img: 'Assets/HeroPick/rafaela.png', sound: 'Assets/Sound/Rafaela.new.select01.ogg' },
    { name: 'roger', img: 'Assets/HeroPick/roger.png', sound: 'Assets/Sound/Roger.select.ogg' },
    { name: 'ruby', img: 'Assets/HeroPick/ruby.png', sound: 'Assets/Sound/Ruby.select.ogg' },
    { name: 'saber', img: 'Assets/HeroPick/saber.png', sound: 'Assets/Sound/saber-select.ogg' },
    { name: 'selena', img: 'Assets/HeroPick/selena.png', sound: 'Assets/Sound/Selena.select.ogg' },
    { name: 'silvanna', img: 'Assets/HeroPick/silvanna.png', sound: 'Assets/Sound/Silvanna.select01.ogg' },
    { name: 'sora', img: 'Assets/HeroPick/sora.png', sound: 'Assets/Sound/Audio1211-select.ogg' },
    { name: 'sun', img: 'Assets/HeroPick/sun.png', sound: 'Assets/Sound/Sun-select.ogg' },
    { name: 'suyou', img: 'Assets/HeroPick/suyou.png', sound: 'Assets/Sound/suyou-select.ogg' },
    { name: 'terizla', img: 'Assets/HeroPick/terizla.png', sound: 'Assets/Sound/Terizla.select.ogg' },
    { name: 'thamuz', img: 'Assets/HeroPick/thamuz.png', sound: 'Assets/Sound/Thamuz-select.ogg' },
    { name: 'tigreal', img: 'Assets/HeroPick/tigreal.png', sound: 'Assets/Sound/Tigreal.new.select.ogg' },
    { name: 'uranus', img: 'Assets/HeroPick/uranus.png', sound: 'Assets/Sound/Uranus.select.ogg' },
    { name: 'vale', img: 'Assets/HeroPick/vale.png', sound: 'Assets/Sound/Vale.select.ogg' },
    { name: 'valentina', img: 'Assets/HeroPick/valentina.png', sound: 'Assets/Sound/Valentina.select.ogg' },
    { name: 'valir', img: 'Assets/HeroPick/valir.png', sound: 'Assets/Sound/Valir.move05.ogg' },
    { name: 'vexana', img: 'Assets/HeroPick/vexana.png', sound: 'Assets/Sound/Vexana-select.ogg' },
    { name: 'wanwan', img: 'Assets/HeroPick/wanwan.png', sound: 'Assets/Sound/Wanwan.select.ogg' },
    { name: 'xborg', img: 'Assets/HeroPick/xborg.png', sound: 'Assets/Sound/x borg-select.ogg' },
    { name: 'xavier', img: 'Assets/HeroPick/xavier.png', sound: 'Assets/Sound/Xavier.select.ogg' },
    { name: 'yisunshin', img: 'Assets/HeroPick/yisunshin.png', sound: 'Assets/Sound/Yss.new.select.ogg' },
    { name: 'yin', img: 'Assets/HeroPick/yin.png', sound: 'Assets/Sound/Yin-select.ogg' },
    { name: 'yuzhong', img: 'Assets/HeroPick/yuzhong.png', sound: 'Assets/Sound/Yu zhing-select.ogg' },
    { name: 'yve', img: 'Assets/HeroPick/yve.png', sound: 'Assets/Sound/Yve.select.ogg' },
    { name: 'zetian', img: 'Assets/HeroPick/zetian.png', sound: 'Assets/Sound/Zetian-select.ogg' },
    { name: 'zhask', img: 'Assets/HeroPick/zhask.png', sound: 'Assets/Sound/Zhask.new.select.ogg' },
    { name: 'zhuxin', img: 'Assets/HeroPick/zhuxin.png', sound: 'Assets/Sound/Zhuxin-select.ogg' },
    { name: 'zilong', img: 'Assets/HeroPick/zilong.png', sound: 'Assets/Sound/Zilong.select.ogg' },
];
...
function renderState(state) {
    ...
    if (h1) h1.textContent = state.settings.headerText1 || 'REGULAR SEASON';
    if (h2) h2.textContent = state.settings.headerText2 || 'MATCH 1 - GAME 1';
    if (phase) phase.textContent = isIdle ? 'WAITING' : (state.settings.currentPhaseStatus || '');

    // Update Ban Visibility (Ban 3 Mode)
    const banBoxes = document.querySelectorAll('.ban .ban1');
    if (banBoxes.length >= 10) {
        if (state.settings.draftMode === 'Ban 3') {
            [0, 1, 8, 9].forEach(i => {
                banBoxes[i].style.display = ''; // Bersihkan error sebelumnya
                banBoxes[i].style.visibility = 'hidden';
            });
        } else {
            [0, 1, 8, 9].forEach(i => {
                banBoxes[i].style.display = '';
                banBoxes[i].style.visibility = 'visible';
                banBoxes[i].style.opacity = '1';
            });
        }
    }
